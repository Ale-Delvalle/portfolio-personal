      ...
      <div className={styles.content}>
        ...
        <div className={styles.textsContainer}>
          ...
          <div ref={rightTextRef} className={styles.rightColumn}>
            ...
            {/* Copia de los botones que solo se muestra en pantallas bajas de escritorio
                (ver Hero.module.css, breakpoint min-width:1024px/max-height:880px). Al vivir
                dentro de rightColumn, queda pegada al final de "¿Cómo trabajo?" con el mismo
                gap que separa las dos tarjetas, sin depender de la altura de la columna de la
                foto. El grupo original (arriba, junto a la foto) se oculta con CSS en ese
                breakpoint para no duplicar los botones visualmente. */}
            <div className={`${styles.buttonGroup} ${styles.buttonGroupClone}`}>
              <div className={styles.buttonRow1}>
                <button
                  className={styles.primaryBtn}
                  onClick={() => {
