    ...
    <section id="about" ref={sectionRef} className={styles.section} data-section-trigger>
      ...
      <div className={styles.paragraphsWrapper}>
        ...
        <p ref={p3Ref} className={styles.paragraph}>
          Me especializo en backend porque es donde más disfruto: diseñar el modelo de datos, estudiar las entidades y sus relaciones, y definir la lógica de negocio antes de escribir una sola línea de código. Me gusta empezar por el problema, no por la solución.
        </p>
